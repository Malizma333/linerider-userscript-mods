          ...
          e("input", {
            ...
            onChange: (e) =>
              this.onSetIndex(
                this,
                index,
                2400 * Math.floor(targetFrame / 2400) + 40 * parseInt(e.target.value || 0) + targetFrame % 40,
              ),
          }),
          ":",
          e("input", {
            ...
            onChange: (e) =>
              this.onSetIndex(this, index, 40 * Math.floor(targetFrame / 40) + parseInt(e.target.value || 0)),
          }),
        );
    }
    ...
    renderSpawnpointKeyframe(index) {
      return e(
        ...
        this.renderDouble(
          "pos",
          index,
          [this.state.spawnPointKeyframes[index][1][0], this.state.spawnPointKeyframes[index][1][1]],
          "Position",
          ["X", "Y"],
          true,
          [this.onSetPosX, this.onSetPosY],
        ),
        this.renderDouble(
          "vel",
          index,
          [this.state.spawnPointKeyframes[index][1][2], this.state.spawnPointKeyframes[index][1][3]],
          "Velocity",
          ["X", "Y"],
          true,
          [this.onSetVelX, this.onSetVelY],
        ),
        this.renderSingle(
          "angle",
          index,
          this.state.spawnPointKeyframes[index][1][4],
          "Angle",
          true,
          true,
          this.onSetAngle,
    ...
    render() {
      return e(
        ...
        this.state.active && e(
          ...
          e(
            "div",
            { style: { overflowY: "scroll", height: "15vh", border: "1px solid black" } },
          ...
          e("input", {
            ...
            type: "file",
            accept: ".json",
            onClick: (e) => this.onConfirmUpload(e),
          ...
          e("input", {
            id: "indexView",
            type: "checkbox",
            value: this.state.indexView,
            onChange: () => this.onToggleIndexView(),
          }),
        ),
        e(
          "button",
